...
CREATE TABLE dbo.ActorsCommittedMovies
(
...
ALTER TABLE ActorsCommittedMovies ADD CONSTRAINT PK_ActorsCommittedMovies PRIMARY KEY CLUSTERED (ActorCommittedId);

ALTER TABLE ActorsCommittedMovies ADD FOREIGN KEY (MovieId) REFERENCES dbo.Movie(MovieId);

ALTER TABLE ActorsCommittedMovies ADD FOREIGN KEY (ActorId) REFERENCES dbo.Actor(ActorId);
